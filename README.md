...
- [Crusader](https://crusaderproxy.com) - A local-first web security proxy for HTTP/2 and WebSocket interception, mobile traffic capture with Frida cert-pinning bypass, response diffing, and IDOR/BOLA replay.
